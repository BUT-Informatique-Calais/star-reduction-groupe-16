"""
FITS image loading and preprocessing module
...
class ImageLoader:
    """
    FITS image loader with preprocessing for processing.
    ...
    def __init__(self, fits_path: Path | str):
        """
        Initializes the loader with a FITS file.
    ...
    def __repr__(self) -> str:
        return f"ImageLoader(path={self.fits_path.name}, shape={self.shape})"
